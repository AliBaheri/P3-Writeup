...
### Conclusion
While the results are sasitfactory for the first track, the car is not able to sucessfuly run in the jungle track. My plan is to revisit this project to find a solution for the second track.
